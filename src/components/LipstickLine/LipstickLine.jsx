...
function LipstickLine() {
    ...
    return (
        <div className={`lipstick-line-wrapper ${hidden ? "hidden" : ""}`}>
            ...
            >
                <g transform="translate(-0.48268955,-43.711266)" filter="url(#shadow)">
                ...
                <defs>
                    ...
                    <filter id="lipstick-effects">
                        <feGaussianBlur in="SourceAlpha" stdDeviation="3" result="blur"/>
                        <feSpecularLighting in="blur" surfaceScale="2" specularConstant="0.7"
                            specularExponent="8" lightingColor="#b11e73" result="specOut">
                            <feDistantLight azimuth="240" elevation="20" />
                        </feSpecularLighting>
                        <feComposite in="specOut" in2="SourceAlpha" operator="in" result="specOut2"/>
                        <feComposite in="shadowMerge" in2="specOut2" operator="arithmetic" 
